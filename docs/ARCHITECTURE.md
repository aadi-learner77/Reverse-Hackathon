...
## 3. SDK Component Architecture (Exhibit 04 Specification)

1. **`cool.record()` (`src/cool/client.ts`)**
...
5. **`append()` (`src/cool/phala/log.ts`)**
...
6. **`cool verify` (`src/cool/verify.ts`)**
